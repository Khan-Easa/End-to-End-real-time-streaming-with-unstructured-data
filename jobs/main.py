...
def define_udfs():
    return {'extract_file_name_udf': udf(extract_file_name, StringType()),
...
if __name__ == "__main__":
    ...
    text_input_dir = 'file:\\G:\project_1\jobs\input\input_txt'
    json_input_dir = 'file:\\G:\project_1\jobs\input\input_json'
    csv_input_dir = 'file:\\G:\project_1\jobs\input\input_csv'
    pdf_input_dir = 'file:\\G:\project_1\jobs\input\input_pdf'
    video_input_dir = 'file:\\G:\project_1\jobs\input\input_video'
    image_input_dir = 'file:\\G:\project_1\jobs\input\input_img'
    ...
    query = streamWriter(union_dataframe, 's3a://project-1-for-job/checkpoints/',
                         's3a://project-1-for-job/data/spark_unstructured')
